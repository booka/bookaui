...
public class BokEditorWidget extends Composite implements BokEditorDisplay {

    interface ClipEditorWidgetUiBinder extends UiBinder<Widget, BokEditorWidget> {
    }
